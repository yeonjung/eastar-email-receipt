  ...
  ko: {
    ...
    noticeSections: [
      ...
      { title: '탑승 수속 규정', items: [
        <>탑승 수속 마감 시간은 <span className="text-[#D6001C]">출발 1시간 전</span>에 마감되오니 <span className="text-[#D6001C]">출발 2시간 전까지(인천공항은 3시간 전)</span> 공항에 도착해 주시기 바랍니다.</>,
      ...
      { title: '항공권 변경 및 취소 안내', items: [
        ...
        <>여정 변경/취소 시 사전 좌석, 기내식, 사전 구매 위탁수하물도 함께 취소되며, 해당 부가서비스 환불 규정에 따릅니다. <span className="font-extrabold text-[#D6001C] underline underline-offset-2 decoration-[#D6001C]">수화물 규정 상세보기</span></>,
