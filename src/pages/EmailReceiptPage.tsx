  ...
  ko: {
    ...
    noticeSections: [
      { title: '항공권 계약 조건', items: [
        '이스타항공 국내 여객 운송 약관이 적용되며, 국내 여객 운송 약관은 이스타항공 홈페이지를 통해 확인하실 수 있습니다.',
        '항공권은 타인에게 양도할 수 없으며, 신분증 상의 성명과 예매확인서 상의 이름이 반드시 일치해야 합니다.',
      ...
      { title: '탑승 수속 규정', items: [
        <>탑승 수속 마감 시간은 <span className="text-[#D6001C]">출발 30분 전</span>에 마감되오니 <span className="text-[#D6001C]">출발 1시간 전</span>까지 공항에 도착해 주시기 바랍니다.</>,
        '신분할인이 적용된 경우 증빙서류를 필히 지참하여 주시기 바랍니다.',
      ]},
      { title: '항공권 변경 및 취소 안내', items: [
        '항공권에 대한 규정은 구매처에 따라 상이할 수 있습니다.',
        '공항 지점 또는 예약센터에서 변경/취소 시 편도 5,000원의 서비스 수수료가 추가로 부과됩니다.',
        <>여정 변경/취소 시 사전 좌석, 기내식, 사전구매 위탁수하물도 함께 취소되며, 해당 부가서비스 환불 규정에 따릅니다. <span className="font-extrabold text-[#D6001C] underline underline-offset-2 decoration-[#D6001C]">수화물 규정 상세보기</span></>,
        '좌석을 점유하지 않는 유아는 변경/취소 수수료가 부과되지 않습니다.',
        '구매 후 24시간 이내 변경/취소 시 수수료가 면제됩니다. (단, 국내선 출발 이후에는 수수료 부과)',
